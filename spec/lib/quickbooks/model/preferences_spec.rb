describe "Quickbooks::Model::Preferences" do
  it "should parse from XML" do
    ...
    preferences.tax.using_sales_tax?.should be false
    preferences.tax.partner_tax_enabled?.should be false
    preferences.time_tracking.bill_customers?.should be true
    ...
    preferences.sales_forms.auto_apply_credit?.should be true
