...
describe Quickbooks::Model::BatchResponse do
  it "parse from XML" do
    ...
    batch_response.response_items.size.should == 3
    ...
    item_res2 = batch_response.response_items[2]
    item_res2.bId.should == "3d"
    item_res2.should_not be_a_fault
    item_res2.item.should_not be_nil
    item_res2.item.id.should == 19891
  end
end
