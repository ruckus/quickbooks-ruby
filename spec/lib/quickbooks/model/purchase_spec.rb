describe "Quickbooks::Model::Purchase" do
  ...
  it "parse from XML (cash)" do
    ...
    tax_line1.tax_line_detail.percent_based?.should be true
    ...
    tax_line2.tax_line_detail.percent_based?.should be true
    ...
    tax_line3.tax_line_detail.percent_based?.should be true
